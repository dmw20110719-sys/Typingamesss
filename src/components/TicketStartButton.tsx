...
interface TicketStartButtonProps {
  homeScope: "korea" | "japan" | "usa" | "china" | "vietnam" | "world";
  level: string;
...
const scopeThemes: Record<string, ScopeTheme> = {
  ...
  vietnam: {
    topStripe: "bg-gradient-to-r from-red-600 via-red-500 to-yellow-500",
    logoBg: "bg-red-600 text-yellow-300 font-bold",
